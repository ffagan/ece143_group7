...
def clean_UCI_h(extra=False):
    '''
    This function extracts the data and performs cleaning for the Hungarian data file
    (hungarian.data) from the UCI dataset
